package java.io.nanodegree.popularmovies.feature.movie.presentation.moviedetail.recyclerview;
...
import java.io.nanodegree.popularmovies.feature.movie.data.model.Review;
...
public class ReviewsAdapter extends RecyclerView.Adapter<ReviewsAdapter.ReviewItemViewHolder> {
    ...
    class ReviewItemViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        void bind(Review review) {
            this.review = review;
            tv_review_title.setText(String.format("%s %s", context.getString(R.string.detail_review_by), review.getAuthor()));
