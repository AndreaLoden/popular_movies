...
class RecipeTableViewController: UITableViewController, MovieListView {

    var movies = [RecipesDisplay.Result]()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.ingredients.text = movie.ingredients
        return cell
    }
    
    func showState(state: MovieState) {
        state.popularMoviesResponse.map(this@MovieListFragment::showMovieList)
    }

    func showMovieList(movieList: List<MovieContainer.Movie>) {
          movies = movieList
